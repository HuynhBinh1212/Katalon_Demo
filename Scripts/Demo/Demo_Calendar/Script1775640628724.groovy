...
WebUI.click(findTestObject('Object Repository/Login_Demo/Page_Dashboard_Login/a_CURA Healthcare_menu-toggle'))
...
WebUI.click(findTestObject('Object Repository/Login_Demo/Page_Demo_Caledar/input_date'))

WebUI.setText(findTestObject('Object Repository/Login_Demo/Page_Demo_Caledar/input_date'), '22/04/2026')

String actualDate = WebUI.getAttribute(findTestObject('Object Repository/Page_Cura/input_VisitDate'), 'value')

WebUI.verifyMatch(actualDate, '22/04/2026', false)
