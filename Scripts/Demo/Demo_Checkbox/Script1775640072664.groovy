...
WebUI.check(findTestObject('Object Repository/Login_Demo/Page_Demo_Checkbox/input_Checkbox'))

WebUI.verifyElementChecked(findTestObject('Object Repository/Login_Demo/Page_Demo_Checkbox/input_Checkbox'), 5)

WebUI.uncheck(findTestObject('Object Repository/Login_Demo/Page_Demo_Checkbox/input_Checkbox'))
